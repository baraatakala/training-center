...
const MOOD_EMOJIS = [
  ...
  { emoji: 'Ã°Å¸Â¤â€', label: 'Confused' },
  { emoji: 'Ã°Å¸ËœÂ', label: 'Neutral' },
  { emoji: 'Ã°Å¸ËœÅ ', label: 'Happy' },
  { emoji: 'Ã°Å¸â€Â¥', label: 'Energized' },
];
  ...
  if (submitted) {
    return (
      <div className="animate-scale-in mt-6 text-center p-6 bg-purple-50 dark:bg-purple-900/30 rounded-2xl border border-purple-200 dark:border-purple-700">
        <span className="text-5xl block mb-3">Ã°Å¸â€™Å“</span>
        ...
        {anonymousAllowed && (
          <label className="flex items-center gap-2 mb-4 cursor-pointer select-none">
            ...
            <span className="text-xs text-gray-600 dark:text-gray-400">
              Ã°Å¸â€¢ÂµÃ¯Â¸Â Submit anonymously
            </span>
          </label>
        )}
        ...
        <div className="flex gap-3">
          ...
          >
            {submitting ? (
              ...
              <span>Ã°Å¸â€™Å“ Submit Feedback</span>
            )}
          </Button>
        </div>
      </div>
