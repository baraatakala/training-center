    ...
    <div className="space-y-4 md:space-y-6 p-4 md:p-0">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 mt-1">{teachers.length} total teachers</p>
        </div>
        {isTeacher && (
      ...
      {loading ? (
        <div className="text-center py-12 dark:text-gray-300">Loading teachers...</div>
      ) : (
